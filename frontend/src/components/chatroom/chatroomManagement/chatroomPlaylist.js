...
import { getGroupPlaylist } from '../../../socket/playlistSocket';
...
class Playlist extends Component {
    ...
    async componentDidMount() {
        getGroupPlaylist(this.props.id_group, (err, data) => {
            console.log(data);
            this.setState({ groupPlaylists: data });
        });
    }
    componentDidUpdate() {
        if (this.props.groupPlaylists.length != this.state.groupPlaylists.length)
            getGroupPlaylist(this.props.id_group, (err, data) => {
                console.log(data);
                this.setState({ groupPlaylists: data });
